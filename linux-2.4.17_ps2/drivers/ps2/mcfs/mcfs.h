 ...
 *
 * $Id: mcfs.h,v 1.1.2.2 2002/04/17 11:29:40 takemura Exp $
 */
#ifndef _PS2MCFS_H_
#define _PS2MCFS_H_
...
#define PS2MCFS_DIRENT_BITS	16
#define PS2MCFS_SECTOR_BITS	16
...
int ps2mcfs_setattr(struct dentry *dentry, struct iattr *attr);
